...
public class ProfessorLogIn extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ProfessorLogIn().setVisible(true));
    }
